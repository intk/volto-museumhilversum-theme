...
/**
 * Component to display the homepage view.
 * @function HomepageView
 * @param {Object} content Content object.
 * @returns {string} Markup of the component.
 */
const HomepageView = ({ content, intl, location }) => {
  ...
  return hasBlocksData(content) ? (
    <div id="page-document" className="ui container homepage-view">
...
export default injectIntl(HomepageView);
